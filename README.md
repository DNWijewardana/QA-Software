...
| `packages/engines` | Pluggable engine adapters (`TestEngine`, `Scanner`, … — spec VI.2): profiler, secret-scanner, code-quality, dependency-scanner, dockerfile-scanner, kubernetes-scanner |
